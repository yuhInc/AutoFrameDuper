...
def main():
    ...
    layout = [  
                [sg.Menu(menu)],
                [sg.Text('Left click delay: '), sg.Slider(range=(1, 10), default_value=2, orientation='h', size=(30, 30)), sg.Text('Ticks')],
                ...
                [sg.Button('Start Script'),sg.Button("Info"),sg.Text('', size=(32, 0)), sg.Button('Close')],
                [sg.StatusBar('Script not running', key='-STATUS-')]]
    window = sg.Window('Automated Frame Duper by yuh#0004', layout, size=(550, 190), font='standart', icon=r"item_frame.ico")
